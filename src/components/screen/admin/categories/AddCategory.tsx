...
export const AddCategory = ({ onClose, onSuccess }: AddCategoryProps) => {
  ...
  const { loading: addLoading, execute: addExecute } = usePost<
    { data: ICategory },
    FormData
  ...
  return (
    <div className="flex h-auto flex-col gap-4 rounded-lg bg-white p-4">
      <h3 className="text-center text-xl font-bold">Add New Category</h3>
